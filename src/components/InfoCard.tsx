        ...
        <>
          ...
          {hasMore && (
            <button
              ...
              className="self-start mt-1 text-xs font-medium text-[#F5A524] hover:text-amber-600 transition-colors flex items-center gap-1"
            >
              {expanded ? (
                <>
                ...
                <>
                  <span className="text-base leading-none">↓</span> Show {items.length - collapsedCount} more
                </>
              )}
            </button>
          )}
